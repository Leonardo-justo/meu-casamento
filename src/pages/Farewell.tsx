...
export default function Farewell() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-24 text-center">
      <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="bg-white border border-stone-100 rounded-3xl p-10 shadow-sm">
        <Heart className="mx-auto text-rose-300 fill-rose-300 mb-5" size={34} />
        <h1 className="text-5xl font-serif text-stone-800 mb-5">Nos vemos no grande dia</h1>
